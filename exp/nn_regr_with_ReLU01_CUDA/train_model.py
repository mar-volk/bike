...
for weight_decay in weight_decay_list:
    ...
    # initialize model
    model = models.NNLinRegr2LayersReLU('NNLinRegr2LayersReLU', x_train.shape[1], d_h=2000, d_out=1, p_drop=0, device=device)
    ...
    trained_model = training.run_train(2000, lr=0.01, batch_size=1024, weight_decay=weight_decay)
